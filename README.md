...
## My skills 🫡
[![My Skills](https://skillicons.dev/icons?i=js,html,css,react,next,laravel,figma,discord,discordjs,nodejs,dotnet,cs,c,cpp,haxe,python,java,ts,php,mysql,wordpress,pycharm,phpstorm,webstorm,github,deno,uv,flask)](https://skillicons.dev)
